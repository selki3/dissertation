...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        if logged_in:
            ...
            self.result_button.clicked.connect(lambda: question_model.digital_twin_training(user_id=user))
            layout.addWidget(self.result_button)

            self.logout_button = QPushButton("Logout")
            self.logout_button.clicked.connect(self.show_relogin)
    ...
    def show_welcome_window(self, user_id):
        global logged_in 
        logged_in = True
        global user
        print(user_id["id"])
...
#        
        ...
        self.button_group1.buttonClicked.connect(lambda: q_controller.extract_information(self.button_group1.checkedId()+1, 1))
        ...
        self.button_group2.buttonClicked.connect(lambda: q_controller.extract_information(self.button_group2.checkedId()+1, 2))
        ...
        self.button_group3.buttonClicked.connect(lambda: q_controller.extract_information(self.button_group3.checkedId()+1, 3))
        ...
        self.button_group4.buttonClicked.connect(lambda: q_controller.extract_information(self.button_group4.checkedId()+1, 4))
        ...
        self.button_group5.buttonClicked.connect(lambda: q_controller.extract_information(self.button_group5.checkedId()+1, 5))
        ...
        self.button_group6.buttonClicked.connect(lambda: q_controller.extract_information(self.button_group6.checkedId()+1, 6))
        ...
        self.button_group7.buttonClicked.connect(lambda: q_controller.extract_information(self.button_group7.checkedId()+1, 7))
        ...
        self.button_group8.buttonClicked.connect(lambda: q_controller.extract_information(self.button_group8.checkedId()+1, 8))
        ...
        self.button_group9.buttonClicked.connect(lambda: q_controller.extract_information(self.button_group9.checkedId()+1, 9))
        ...
        self.button_group10.buttonClicked.connect(lambda: q_controller.extract_information(self.button_group10.checkedId()+1, 10))
        ...
        self.button_group11.buttonClicked.connect(lambda: q_controller.extract_information(self.button_group11.checkedId()+1, 11))
        ...
        self.button_group12.buttonClicked.connect(lambda: q_controller.extract_information(self.button_group12.checkedId()+1, 12))
        ...
        self.button_group13.buttonClicked.connect(lambda: q_controller.extract_information(self.button_group13.checkedId()+1, 13))
        ...
        self.button_group14.buttonClicked.connect(lambda: q_controller.extract_information(self.button_group14.checkedId()+1, 14))

        self.continue_button = QPushButton('Continue')
        self.grid_layout.addWidget(self.continue_button)
        self.continue_button.clicked.connect(lambda: question_model.digital_twin_training(q_controller.answers, q_controller.medication, user))
